      ...
      <nav className="border-b border-border bg-background/90 backdrop-blur-xl sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-6 lg:px-8 flex items-center justify-between h-16 lg:h-20">
          ...
          <div className="flex items-center gap-6">
            ...
            <a href="/sobre" className="text-sm font-body text-muted-foreground hover:text-foreground transition-colors hidden md:block">Sobre Nós</a>
        ...
        <section className="py-24 lg:py-32 text-center px-6">
          ...
          >
            ...
            <p className="font-body text-lg text-muted-foreground max-w-2xl mx-auto">
              Cada case representa um desafio real enfrentado por uma organização — e a engenharia de alto nível que aplicamos para resolvê-lo.
            </p>
          </motion.div>
        </section>
          ...
          <div className="grid md:grid-cols-2 gap-8 lg:gap-10">
            {CASES.map((c, i) => (
              <motion.div
                ...
                className="group relative bg-card border border-border rounded-xl overflow-hidden hover:border-primary/40 hover:shadow-xl hover:shadow-primary/5 transition-all duration-400"
              >
                {/* Cover image */}
